$(document).ready(function() {
    ...
    $("#back-create-form").on("click", function() {
        ...
        $(".form-input-details, .control-id-create, .control-id-google").val("");
        ...
        var uploadGoogleField = ["#googleFormTitle", "#googleFormLink", ".control-id-google", "#googleFormType", "#googleFormDescription", ".control-id-create", "#create-form-type", "#uploadSurveyTitle", "#formDescription", "#customFile"];
    ...
    $(document).on("click", ".add-option", function(){
     ...
     // save survey form
    $("#uploadSurveyForm").on("submit", function(e) {
        e.preventDefault();
        var data = new FormData(),
            file = $('#customFile')[0].files[0];
        data.append('file', file);
        data.append('control_id', $(".control-id-create").val());
        data.append('form_type', $("#create-form-type").val());
        data.append('title', $("#uploadSurveyTitle").val());
        data.append('description', $("#formDescription").val());
